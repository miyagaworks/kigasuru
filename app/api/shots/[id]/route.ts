  ...
  try {
    ...
    const updatedShot = await prisma.shot.update({
      ...
      data: {
        ...
        club: body.club,
        distance: body.distance === null ? null : body.distance !== undefined ? parseInt(String(body.distance)) : undefined,
        slope: body.slope,
        lie: body.lie,
        ...
        latitude: body.latitude === null ? null : body.latitude !== undefined ? parseFloat(String(body.latitude)) : undefined,
        longitude: body.longitude === null ? null : body.longitude !== undefined ? parseFloat(String(body.longitude)) : undefined,
        actualTemperature: body.actualTemperature === null ? null : body.actualTemperature !== undefined ? parseFloat(String(body.actualTemperature)) : undefined,
