...
CREATE TABLE "User" (
    ...
    "lineUserId" TEXT,
    "lineNotificationEnabled" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "UserSettings" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "gyroPermission" BOOLEAN NOT NULL DEFAULT false,
    "gyroCalibrated" BOOLEAN NOT NULL DEFAULT false,
    "flatThreshold" DOUBLE PRECISION NOT NULL DEFAULT 5.0,
    "inputLevel" TEXT NOT NULL DEFAULT 'standard',
    "enabledFields" JSONB NOT NULL,
    "clubs" JSONB NOT NULL,
    "gyroCalibration" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Shot_date_idx" ON "Shot"("date");
